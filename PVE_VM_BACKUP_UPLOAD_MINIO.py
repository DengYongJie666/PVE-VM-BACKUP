...
def upload_to_minio(minio_client, bucket_name, local_file_path, object_name):
    try:
        file_size = os.path.getsize(local_file_path)

        upload_progress_bar = tqdm(total=file_size, unit='B', unit_scale=True, desc=f"Uploading {os.path.basename(object_name)}")

        def progress_callback(bytes_transferred):
            upload_progress_bar.update(bytes_transferred)
            ...
            for backup in backups:
                ...
                for backup_id in backup_ids:
                    ...
                    try:
                        ...
                        upload_to_minio(minio_client,minio_bucket_name,local_file_path,object_name)
